/*
 * SVG Icon Components — built from provided asset pack
 * All icons use `currentColor` for fill/stroke so they inherit the parent text color.
 * No external icon libraries used — pure inline SVG.
 *
 * Design system: "Neural Deep Ocean"
 * Colors: Forsythia (#FFC801), Nocturnal (#114C5A), Saffron (#FF9932), Oceanic (#172B36)
 */
...
function withColor(props: SVGProps<SVGSVGElement>): SVGProps<SVGSVGElement> {
  const cloned = { ...props };
  // Strip hardcoded fills and strokes so they inherit currentColor
  return cloned;
}

export function CogIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} className={className} {...withColor(props)}>
...
export function CubeIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} {...withColor(props)}>
...
export function ChartPieIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} className={className} {...withColor(props)}>
...
export function ChevronUpSolidIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} {...withColor(props)}>
...
export function ArrowPathIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} className={className} {...withColor(props)}>
...
export function ArrowTrendingUpIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} className={className} {...withColor(props)}>
...
export function LinkSolidIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} {...withColor(props)}>
...
export function SearchIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="currentColor" className={className} {...withColor(props)}>
...
/* Brand Logo — interlocking loop symbol from generated asset */
export function BrandLogoIcon({ size = 40, className, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none" className={className} {...withColor(props)}>
      <circle cx="38" cy="50" r="22" stroke="currentColor" strokeWidth="5" fill="none" />
      <circle cx="62" cy="50" r="22" stroke="currentColor" strokeWidth="5" fill="none" />
      <rect x="44" y="35" width="12" height="30" rx="3" fill="currentColor" />
    </svg>
  );
}
